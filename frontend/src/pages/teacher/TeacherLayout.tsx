    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        <aside style={{ width: 220, borderRight: '1px solid var(--glass-border)', padding: '20px 12px' }}>
          ...
          <NavLink to="dashboard" style={({ isActive }) => ({ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', borderRadius: 10, fontSize: 14, fontWeight: 600, textDecoration: 'none', color: isActive ? 'var(--text-main)' : 'var(--text-muted)', background: isActive ? 'rgba(34,197,94,0.12)' : 'transparent' })}>
            🏫 Console
          </NavLink>
        </aside>
